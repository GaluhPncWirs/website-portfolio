...
export default function SideBar() {
  return (
    <div className="md:h-[96%] md:m-3 max-[640px]:hidden sm:block sm:w-full sm:static md:fixed md:w-1/3 lg:w-1/4">
      <div className="bg-gray-700 rounded-xl sm:absolute sm:p-3 sm:mx-5 sm:flex sm:gap-x-3 sm:mt-5 sm:h-1/3 md:static md:p-0 md:mx-0 md:flex-col md:gap-x-0 md:mt-0 md:h-full md:py-3">
        <div className="flex flex-col justify-center items-center sm:w-1/3 md:w-full md:gap-y-2 lg:gap-y-1">
          <img
            src="./images/profile.png"
            className="rounded-full w-1/2 sm:w-3/5"
          />
          <h1 className="mt-5 mb-4 font-semibold text-slate-400 sm:my-3 sm:text-lg md:text-2xl">
            Galuh Panca Wirasa
          </h1>
        ...
        <hr className="border-slate-500 border w-5/6 mx-auto mt-10 sm:hidden md:block md:my-5" />
