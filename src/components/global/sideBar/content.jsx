...
export default function SideBar() {
  return (
    <div>
      <div className="hidden sm:block md:fixed md:h-[96%] md:w-1/3 lg:w-1/4 xl:max-w-xs print:relative print:block print:w-full print:h-auto print:mb-5">
          ...
          <div className="items-center gap-3 sm:flex sm:justify-around md:flex-col print:flex-col print:items-start print:gap-5">
            ...
            <div className="flex flex-col items-center justify-center print:flex-row print:gap-4 print:items-center">
              <img
                ...
                className="object-cover border-4 rounded-full shadow-xl size-36 border-slate-500/30 print:size-24"
                loading="eager"
              />
            ...
            <hr className="w-4/5 mx-auto border border-slate-500 sm:hidden md:block md:my-2 print:hidden" />

            {/* Info Details Section */}
            <div className="flex flex-col md:items-center sm:justify-around sm:gap-2.5 md:gap-5 md:justify-center lg:gap-3 print:grid print:grid-cols-2 print:gap-x-8 print:gap-y-5 print:place-content-center print:w-full">
